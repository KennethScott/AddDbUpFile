...
namespace KennethScott.AddDbUpFile
{
	...
	{
		private static readonly DTE2 _dte = AddDbUpFilePackage._dte;
		...
		public static ProjectItem AddFileToProject(this Project project, FileInfo file, string itemType = null, bool isEmbeddedResource = false)
		{
